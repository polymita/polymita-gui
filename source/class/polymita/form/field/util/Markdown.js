/**
 * @childControl dlg {polymita.form.dialog.MarkdownEditor} Form dialog.
 */
qx.Class.define("polymita.form.field.util.Markdown", {
    ...
    members: {
        _onOpenDlg: function (e) {
            if (!this.isReadOnly()) {
                var dlg = new polymita.form.dialog.MarkdownEditor();
